...
with program() as calib_delays:
    ...
    with for_(n, 0, n < n_avg, n + 1):
        ...
        # wait(initial_delay_cycles + 125, "NV")  # delay the microwave pulse
        ...
        measure("readout", "SPCM_OPD", None, time_tagging.digital(times, meas_len, counts))
        wait(wait_between_runs, "SPCM_OPD")
