...
with program() as counter:
    ...
    with infinite_loop_():
        with for_(n, 0, n < n_count, n + 1):
            ...
            measure("readout", "SPCM_OPD", None, time_tagging.digital(times, single_integration_time_ns, counts))
            assign(total_counts, total_counts + counts) #assign is equal in qua language
