...
try:
    ...
    if type == ctl.ChannelModuleType.STICK_SLIP_PIEZO_DRIVER:
        ...
        # amir ctl.SetProperty_i32(d_handle, channel, ctl.Property.MAX_CL_FREQUENCY, 6000)
        res = ctl.GetProperty_i32(d_handle, channel, ctl.Property.MAX_CL_FREQUENCY)
        print("ctl.Property.MAX_CL_FREQUENCY = " + str(res))
        ...
        # amir ctl.SetProperty_i32(d_handle, channel, ctl.Property.HOLD_TIME, 1000)
        res = ctl.GetProperty_i32(d_handle, channel, ctl.Property.HOLD_TIME)
        print("ctl.Property.HOLD_TIME = " + str(res))
