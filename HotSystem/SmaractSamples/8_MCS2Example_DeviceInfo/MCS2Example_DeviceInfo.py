...
# SmarAct MCS2 programming example: AttoDry800xs-Info
#
...
print("*******************************************************")
print("*  SmarAct MCS2 Programming Example (AttoDry800xs Info)     *")
print("*******************************************************")
...
try:
    ...
    print("AttoDry800xs Serial Number: {}".format(serial))
    name = ctl.GetProperty_s(d_handle, 0, ctl.Property.DEVICE_NAME)
    print("AttoDry800xs Name: {}".format(name))
    ...
    for i in range(no_of_bus_modules):
        ...
        if mod_type == ctl.ChannelModuleType.STICK_SLIP_PIEZO_DRIVER:
            ...
            print(" (E-Magnetic-Driver):")
        elif mod_type == ctl.ChannelModuleType.PIEZO_SCANNER_DRIVER:
            print(" (Piezo-Scanner-Driver):")
