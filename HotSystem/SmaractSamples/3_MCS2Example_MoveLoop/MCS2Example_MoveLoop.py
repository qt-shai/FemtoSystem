...
try:
    ...
    no_of_sequences = 2
    if type == ctl.ChannelModuleType.STICK_SLIP_PIEZO_DRIVER or type == ctl.ChannelModuleType.PIEZO_SCANNER_DRIVER:
        ...
        # E-magnetic driven positioners are always in the holding state when stopped. Therefore
    ...
    if type == ctl.ChannelModuleType.PIEZO_SCANNER_DRIVER:
        position = 1000000;     # 1 um
    else:
